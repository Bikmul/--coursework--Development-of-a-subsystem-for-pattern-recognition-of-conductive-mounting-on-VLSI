Данный код реализует простую функцию для обнаружения объектов на изображении с использованием предобученной модели Faster R-CNN на базе ResNet-50. Вам предлагается выполнить следующую последовательность действий:
